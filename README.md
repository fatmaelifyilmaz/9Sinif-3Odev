...
Yukarıdaki örneği kullanarak **kendi ölçümlerinizle** bir tablo oluşturun (hiç değilse birkaç frame benim ölçümlerinden farklı olsun.) 
[https://docs.google.com/spreadsheets/d/1YlJZr6fageo6vV_l4inPgkzW_QdU_LqowA2Gelk_fFQ/edit#gid=0] 

a) Denkleminizi **-1,25x^2+ 3E-03+ 1,83x**. Sizce a, b, ve c'nin fiziksel anlamları ne olabilir? Sizce niçin a'nın değeri negatif? 
**"a ivmeden kaynaklı hız değişimini gösteren katsayı olabilir","b ise cismin başlangıçtaki atış hızı olabilir"** 
b) Hava sürtünmesini ihmal edersek, bu harakette ivme sabit midir? 
**bence değildir çünkü cisme tek etki eden hava sürtünmesi değil aynı zamanda buluduğu yüzeydeki sürtünme de cisim üzerinde etkilidir** 
...
1) Kendi aldığınız verileri kullanarak **ortalama hız-zaman** grafiğini Google çiziniz.
[https://docs.google.com/spreadsheets/d/1vGAC0x_WjYWbmOGB1llCbkDfAVv4swnu6u__5efjcYE/edit#gid=0]
...
**Zamandaki ölçüm hatası 1/60 mili saniye olabilir. Konum değerini bulurken milimetrik hesaplar yapılmadığından ve ortalama değer alındığından sapma olmuş olabilir**
